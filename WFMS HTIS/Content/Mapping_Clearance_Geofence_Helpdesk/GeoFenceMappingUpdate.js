...
//To Display Mapped Sites based on the Selected Employee On Page Load//
MappedSitesListDisplay()
function MappedSitesListDisplay() {
    $('#ModalProgress').show();
    $.post('/Admin/_GeoFenceMappedSites', {
        'GeoFenceMappingId': $('#GeoFenceMappingId').val()
    }, function (data) {
        $('#MappedSiteList').html(data);
