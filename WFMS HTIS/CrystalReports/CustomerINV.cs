...
namespace Payroll.portal.CrystalReports {
    ...
    public class CustomerINV : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Payroll.portal.CrystalReports.CustomerINV.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedCustomerINV : Component, ICachedReport {
        
        public CachedCustomerINV() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            CustomerINV rpt = new CustomerINV();
            rpt.Site = this.Site;
            return rpt;
        }
