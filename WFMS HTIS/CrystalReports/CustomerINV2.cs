...
namespace Payroll.portal.CrystalReports {
    ...
    public class CustomerINV2 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Payroll.portal.CrystalReports.CustomerINV2.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedCustomerINV2 : Component, ICachedReport {
        
        public CachedCustomerINV2() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            CustomerINV2 rpt = new CustomerINV2();
            rpt.Site = this.Site;
            return rpt;
        }
